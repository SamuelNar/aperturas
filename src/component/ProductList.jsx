          ...
          {isAdmin ? (
            <>
              <button
                ...
                className="px-6 py-2 text-sm bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 transition"
              >
                Agregar Producto
              </button>
              <button
                onClick={onLogout}
                className="px-6 py-2 text-sm bg-red-500 text-white rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 transition"
              >
                Cerrar Sesión
              </button>
            </>
        ...
        {loading ? (
          ...
          products.map((product) => (
            <ProductCard
              ...
              product={product}
              isAdmin={isAdmin}
              onDelete={() => deleteProduct(product.id, product.image)}
            />
          ))
        )}
      </div>
